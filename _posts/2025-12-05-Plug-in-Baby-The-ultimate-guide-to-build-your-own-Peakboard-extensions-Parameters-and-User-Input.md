...
In today's article, we're going to take things one step further. We're going to add some configuration options to our `MeowExtension`. (This is the same thing as when you add a new JSON data source and you have options for the URL, authentication type, path, etc.)
