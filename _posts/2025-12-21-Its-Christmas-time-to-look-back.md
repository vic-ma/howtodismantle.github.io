...
* And in [Cracking the code - Part III](https://how-to-dismantle-a-peakboard-box.com/Cracking-the-code-Part-III-Reading-and-writing-lists-with-Peakboard-Hub-API.html), we explained how to treat Hub lists like a lightweight database.
...
* In [How to handle SAP Inventory](https://how-to-dismantle-a-peakboard-box.com/Because-Nobody-Loves-MI05-How-to-handle-SAP-Inventory.html), we replaced a paper-based physical inventory process with a MI05 workflow that uses a tablet app to talk to BAPIs directly.
...
* In [Building a Next-Gen Continuous Improvement Board](https://how-to-dismantle-a-peakboard-box.com/Elevate-Your-Workflow-Building-a-Next-Gen-Continuous-Improvement-Board-with-Office-365-ToDo.html), we took a more process-driven perspective.
